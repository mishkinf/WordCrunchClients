...
namespace WordCruncherWP7
{
    public abstract class ParticleSystem 
    {
        ...
        /// Update and Draw functions.</remarks>
         protected ParticleSystem(ContentManager content, SpriteBatch spriteBatch, int howManyEffects)
        {
        ...
        public void AddParticles(Vector2 where)
        {
            ...
            int numParticles =
                Helpers.Random.Next(minNumParticles, maxNumParticles);
        ...
        protected virtual void InitializeParticle(Particle p, Vector2 where)
        {
            ...
            float velocity =
                Helpers.RandomBetween(minInitialSpeed, maxInitialSpeed);
            float acceleration =
                Helpers.RandomBetween(minAcceleration, maxAcceleration);
            float lifetime =
                Helpers.RandomBetween(minLifetime, maxLifetime);
            float scale =
                Helpers.RandomBetween(minScale, maxScale);
            float rotationSpeed =
                Helpers.RandomBetween(minRotationSpeed, maxRotationSpeed);
        ...
        {
            float angle = Helpers.RandomBetween(0, MathHelper.TwoPi);
